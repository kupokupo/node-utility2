...
# this function will run the main build
    ...
    alpha)
        ...
        "[npm publishAfterCommitAfterBuild]")
            git add .
            shFilePackageJsonVersionIncrement
            git commit -am "[npm publishAfterCommit]" || true
...
NjJmMmJmNjdmMTQzZGExYjU4MDY5NDlhYTMyNGMwNWY=\
\\2%" \
            .travis.yml
        rm -f .travis.ymln
        # init git
